...
/* @var $searchModel admin\modules\app\models\searchs\Version */
        ...
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => "新建 App Versions", 'class' => "btn btn-default"]).
            ...
            'panel' => [
                'type' => "primary", 
                'heading' => "<i class=\"glyphicon glyphicon-list\"></i> App Versions 列表",
