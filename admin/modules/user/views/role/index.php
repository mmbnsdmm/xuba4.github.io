...
/* @var $searchModel admin\modules\user\models\searchs\AdminAuthItem */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Admin Auth Items');
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'mergeHeader' => true,
                    'buttons' => [
                        'alloc' => function ($url, $model, $key) {
                            return Html::a('分配', $url, [
                                'title' => Yii::t('yii', '分配'),
                                'aria-label' => Yii::t('yii', '分配'),
                                'data-pjax' => '0',
                                'role' => 'modal-remote',
                                'data-toggle' => 'tooltip',
                            ]);
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => "新建 Admin Auth Items", 'class' => "btn btn-default"]).
            ...
            'panel' => [
                'type' => "primary", 
                'heading' => "<i class=\"glyphicon glyphicon-list\"></i> Admin Auth Items 列表",
                ...
                'after' => BulkButtonWidget::widget([
                    'buttons' => Html::a('<i class="glyphicon glyphicon-trash"></i> 删除选择', ["bulkdelete", 'type' => "hard"], [
