...
/* @var $searchModel admin\modules\user\models\searchs\User */
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($m) {
                        return $m->avatar?Html::a(Html::img($m->avatar, ['alt' => '缩略图', 'width' => 120]), $m->avatar):'';
                    },
                ],
                [
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => "新建 Users", 'class' => "btn btn-default"]).
