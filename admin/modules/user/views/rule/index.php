...
?>
<div class="admin-auth-rule-index">
        ...
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    ...
                    ['role' => "modal-remote", 'title' => "新建 Admin Auth Rules", 'class' => "btn btn-default"]).
            ...
            'panel' => [
                'type' => "primary", 
                'heading' => "<i class=\"glyphicon glyphicon-list\"></i> Admin Auth Rules 列表",
