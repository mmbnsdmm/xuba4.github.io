...
class Tag extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'created_by', 'updated_by', 'created_at', 'udpated_at', 'status'], 'trim'],
            [['name', 'created_by', 'created_at', 'udpated_at', 'status'], 'required'],
            [['created_by', 'updated_by', 'created_at', 'udpated_at', 'status'], 'integer'],
            [['name'], 'string', 'max' => 50],
