 ...
 * @property-read array $praiseTypeDesc
 */
class LeaveMessagePraise extends \common\models\db\tables\LeaveMessagePraise
{
    const SCENARIO_TEST = 'test';
    const STATUS_DELETE = -10;
    const STATUS_ACTIVE = 10;
    const PRAISE_TYPE_PRAISE = 1;
    const PRAISE_TYPE_TRAMPLE = 2;
    ...
    public function getPraiseTypeDesc()
    {
        return [
            self::PRAISE_TYPE_PRAISE => "赞",
            self::PRAISE_TYPE_TRAMPLE => "踩",
        ];
    }
