<template>
    <view class="user-center-my-article">
        <ol class="breadcrumb">
            <li>
        ...
        <div class="row">
            <div class="col-xs-12">
                <WLoadMore ref="WODROW_LOAD_MORE_MY_ARTICLE_LIST" @provider="provider" :pageSize="page_size" color="#66ccff">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$refs.WODROW_LOAD_MORE_MY_ARTICLE_LIST.reLoadData()
        },
        methods: {
            provider(pd){
                let _this = this;
                setTimeout(function () {
                    ...
                    _this.$refs.WODROW_LOAD_MORE_MY_ARTICLE_LIST.pushData(res);
                }, 1000);
            },
            getData(pd) {
                let _this = this;
        ...
        onPullDownRefresh() {
            this.$refs.WODROW_LOAD_MORE_MY_ARTICLE_LIST.pullDownRefresh();
        },
        onReachBottom() {
            this.$refs.WODROW_LOAD_MORE_MY_ARTICLE_LIST.reachBottom()
        }
    }
</script>
