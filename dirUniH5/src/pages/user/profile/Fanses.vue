...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$refs.WODROW_LOAD_MORE_PROFILE_FANSES.reLoadData()
        },
        methods: {
            provider(pd){
                let _this = this;
                setTimeout(function () {
                    ...
                    _this.$refs.WODROW_LOAD_MORE_PROFILE_FANSES.pushData(res);
                }, 1000);
            },
            getData(pd) {
                let _this = this;
                ...
                let formParams = {
                    ...
                    fansesForUserId: _this.profileId
                };
        ...
        onPullDownRefresh() {
            this.$refs.WODROW_LOAD_MORE_PROFILE_FANSES.pullDownRefresh();
        },
        onReachBottom() {
            this.$refs.WODROW_LOAD_MORE_PROFILE_FANSES.reachBottom();
        }
    }
</script>
